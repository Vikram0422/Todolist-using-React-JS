...
function App() {
  ...
  return (
    < >
      <Navbar />
      <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-indigo-200 min-h-[80vh] md:w-[35%]">
        <h1 className='font-bold text-center text-3xl'>TaskMaster - Streamline your tasks, all in one spot</h1>
